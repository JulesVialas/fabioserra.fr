    ...
    <div class="container">
        <div class="footer-content footer-content--with-contact">
            ...
            <div class="footer-section footer-socials-vertical">
                ...
                <a href="https://www.tiktok.com/@fabioserra.fr" target="_blank" rel="noopener" aria-label="TikTok"><img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/tiktok.svg" alt="TikTok" style="width:24px;height:24px;filter:invert(1);" /></a>
            </div>
        </div>
